...
public class OpenApiConfig {
    ...
    public RouteLocator routeLocator(RouteLocatorBuilder builder) {
        return builder
                ...
                .route("swtvap-api-order", r -> r.path("/api/order/order-details").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
                .route("swtvap-api-order", r -> r.path("/api/order/order-transactions").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
