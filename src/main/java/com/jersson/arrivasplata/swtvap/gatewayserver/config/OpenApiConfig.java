...
public class OpenApiConfig {
    ...
    public RouteLocator routeLocator(RouteLocatorBuilder builder) {
        return builder
                ...
                .route("swtvap-api-order", r -> r.path("/api/order/order-amounts").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
                .route("swtvap-api-order", r -> r.path("/api/order/orders").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
                .route("swtvap-api-order", r -> r.path("/api/order/orders-details").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
                .route("swtvap-api-order", r -> r.path("/api/order/orders-amounts").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
                .route("swtvap-api-order", r -> r.path("/api/order/orders-transactions").filters(f -> f.filter(filterFactory.apply())).uri("lb://SWTVAP-API-ORDER"))
